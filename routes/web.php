...
route::get("/produk/qr-scan", [QrController::class, 'qr_scan'])->name('index.qr_scan');
route::post("/produk/submit-qr-scan", [QrController::class, 'submit_qr_scan'])->name('index.submit_qr_scan');
